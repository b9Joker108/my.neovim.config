...
20. akinsho/bufferline.nvim - Buffer line for managing open files
...
### **6. `vim.inspect`**
- **What it is**: A Neovim utility for pretty-printing Lua tables (useful for debugging).
- **What it tells us**: This module is loaded and available for debugging purposes.

---

### **7. `vim._editor`**
- **What it is**: An internal Neovim module related to editor state and functionality.
- **What it tells us**: This is part of Neovim’s core editor functionality.

---

### **8. `vim.fs`**
- **What it is**: A Neovim module for file system operations (e.g., finding files,
  listing directories).
- **What it tells us**: This module is loaded and available for file system interactions.

---

### **9. `ffi`**
- **What it is**: The LuaJIT Foreign Function Interface (FFI), which allows Lua to call
  C functions directly.
- **What it tells us**: This is used by plugins or Neovim itself to interact with C
  libraries.

---

### **10. `vim.keymap`**
- **What it is**: A Neovim module for managing key mappings.
- **What it tells us**: This module is loaded and available for defining and managing
  keybindings.

---

### **11. `vim.loader`**
- **What it is**: A Neovim module for loading Lua modules dynamically.
- **What it tells us**: This is part of Neovim’s module loading system.

---

### **12. `vim._defaults`**
- **What it is**: An internal Neovim module for setting default options and
  configurations.
- **What it tells us**: This is part of Neovim’s initialization process.

---

### **13. `vim._options`**
- **What it is**: An internal Neovim module for managing editor options.
- **What it tells us**: This is part of Neovim’s core configuration system.

---

### **14. `vim.shared`**
- **What it is**: A Neovim module for shared state and data between Lua and
  Vimscript.
- **What it tells us**: This is used for interoperability between Lua and
  Vimscript.

---

### **15. `lazyvim.util.inject`**
- **What it is**: A utility module from `LazyVim` for injecting functionality
  or configurations.
- **What it tells us**: This is part of the `LazyVim` framework and is used for
  extending or modifying configurations.

---

### **16. `config.lazy`**
- **What it is**: A configuration module for `lazy.nvim`, likely defining plugin
  specifications.
- **What it tells us**: This is where your plugin configurations are defined.

---

### **17. `lazyvim.config.options`**
- **What it is**: A module for defining Neovim options within the `LazyVim`
  framework.
- **What it tells us**: This is part of the `LazyVim` configuration system.

---

### **18. `lazy.core.util`**
- **What it is**: A utility module from `lazy.nvim` for core functionality.
- **What it tells us**: This is part of the `lazy.nvim` plugin manager.

---

### **19. `vim.uri`**
- **What it is**: A Neovim module for handling URIs (e.g., file paths, URLs).
- **What it tells us**: This is used for working with URIs in plugins or Neovim
  itself.

---

### **20. `lazy.core.plugin`**
- **What it is**: A core module from `lazy.nvim` for managing plugins.
- **What it tells us**: This is part of the `lazy.nvim` plugin manager.

---

### **21. `lazy.manage.runner`**
- **What it is**: A module from `lazy.nvim` for running plugin tasks or commands.
- **What it tells us**: This is part of the `lazy.nvim` task management system.

---

### **22. `lazy.pkg`**
- **What it is**: A module from `lazy.nvim` for managing plugin packages.
- **What it tells us**: This is part of the `lazy.nvim` plugin manager.

---

### **23. `lazy.core.meta`**
- **What it is**: A module from `lazy.nvim` for handling metadata about plugins.
- **What it tells us**: This is part of the `lazy.nvim` plugin manager.

---

### **24. `vim.lsp`**
- **What it is**: A Neovim module for Language Server Protocol (LSP)
  functionality.
- **What it tells us**: LSP support is loaded and available.

---

### **25. `lazyvim.util.lsp`**
- **What it is**: A utility module from `LazyVim` for LSP-related configurations.
- **What it tells us**: This is part of the `LazyVim` framework.

---

### **26. `vim.treesitter.query`**
- **What it is**: A Neovim module for Tree-sitter queries (used for syntax
  highlighting and text objects).
- **What it tells us**: Tree-sitter is loaded and available.

---

### **27. `lazyvim.util.plugin`**
- **What it is**: A utility module from `LazyVim` for plugin management.
- **What it tells us**: This is part of the `LazyVim` framework.

---

### **28. `catppuccin.lib.hashing`**
- **What it is**: A module from the `catppuccin` colorscheme plugin for
  hashing functionality.
- **What it tells us**: The `catppuccin` colorscheme is loaded.

---

### **29. `lazy.stats`**
- **What it is**: A module from `lazy.nvim` for collecting and displaying
  plugin statistics.
- **What it tells us**: This is part of the `lazy.nvim` plugin manager.
...
### **30. `catppuccin`**
- **What it is**: The main module for the `catppuccin` colorscheme.
- **What it tells us**: The `catppuccin` colorscheme is loaded and active.

---

### **31. `lazy.core.config`**
- **What it is**: A core module from `lazy.nvim` for managing plugin
  configurations.
- **What it tells us**: This is part of the `lazy.nvim` plugin manager.

---

### **32. `nvim-treesitter.query_predicates`**
- **What it is**: A module from the `nvim-treesitter` plugin for query
  predicates.
- **What it tells us**: The `nvim-treesitter` plugin is loaded.

---

### **33. `lazy.core.loader`**
- **What it is**: A core module from `lazy.nvim` for loading plugins.
- **What it tells us**: This is part of the `lazy.nvim` plugin manager.

---

### **34. `lazy.core.fragments`**
- **What it is**: A core module from `lazy.nvim` for managing plugin fragments
  (partial configurations).
- **What it tells us**: This is part of the `lazy.nvim` plugin manager.

---

### **35. `lazyvim.plugins.lsp.keymaps`**
- **What it is**: A module from `LazyVim` for defining LSP-related keymaps.
- **What it tells us**: This is part of the `LazyVim` framework.

---

### **36. `lazy.manage.task`**
- **What it is**: A module from `lazy.nvim` for managing plugin tasks.
- **What it tells us**: This is part of the `lazy.nvim` plugin manager.

---

### **37. `lazy.view.commands`**
- **What it is**: A module from `lazy.nvim` for managing plugin-related
  commands.
- **What it tells us**: This is part of the `lazy.nvim` plugin manager.
...
### **38. `lazy.terminal`**
- **What it is**: A module from `lazy.nvim` for terminal integration.
- **What it tells us**: This is part of the `lazy.nvim` plugin manager.

---

### **39. `lazyvim.util.ui`**
- **What it is**: A utility module from `LazyVim` for UI-related functionality.
- **What it tells us**: This is part of the `LazyVim` framework.

---

### **40. `config.options`**
- **What it is**: A module for defining Neovim options in your configuration.
- **What it tells us**: This is part of your custom configuration.

---

### **41. `lazy.core.handler.event`**
- **What it is**: A core module from `lazy.nvim` for handling plugin events.
- **What it tells us**: This is part of the `lazy.nvim` plugin manager.

---

### **42. `catppuccin.palettes.macchiato`**
- **What it is**: A module from the `catppuccin` colorscheme for the
  "macchiato" palette.
- **What it tells us**: The `catppuccin` colorscheme is using the "macchiato"
  palette.

---

### **43. `config.keymaps`**
- **What it is**: A module for defining key mappings in your configuration.
- **What it tells us**: This is part of your custom configuration.

---

### **44. `math`**
- **What it is**: The Lua standard library module for mathematical operations.
- **What it tells us**: This is a core Lua module and is always loaded.

---

### **45. `_G`**
- **What it is**: The Lua global table, which contains all global variables.
- **What it tells us**: This is a core Lua feature and is always present.

---

### **46. `snacks`**
- **What it is**: Likely a custom module or plugin in your configuration.
- **What it tells us**: This is part of your custom setup.

---

### **47. `vim.lsp._snippet_grammar`**
- **What it is**: An internal Neovim module for LSP snippet grammar.
- **What it tells us**: This is part of Neovim’s LSP support.

---

### **48. `string`**
- **What it is**: The Lua standard library module for string manipulation.
- **What it tells us**: This is a core Lua module and is always loaded.

---

### **49. `lazy.core.handler`**
- **What it is**: A core module from `lazy.nvim` for handling plugin events
  and commands.
- **What it tells us**: This is part of the `lazy.nvim` plugin manager.
...
### **50. `catppuccin.palettes.mocha`**
- **What it is**: A module from the `catppuccin` colorscheme for the "mocha"
  palette.
- **What it tells us**: The `catppuccin` colorscheme is using the "mocha"
  palette.

---

### **51. `vim.func._memoize`**
- **What it is**: An internal Neovim module for memoizing functions.
- **What it tells us**: This is part of Neovim’s internal optimization system.

---

### **52. `vim.func`**
- **What it is**: A Neovim module for function-related utilities.
- **What it tells us**: This is part of Neovim’s core functionality.

---

### **53. `lazy.core.handler.ft`**
- **What it is**: A core module from `lazy.nvim` for handling filetype-specific
  plugins.
- **What it tells us**: This is part of the `lazy.nvim` plugin manager.
...
### **54. `table`**
- **What it is**: The Lua standard library module for table manipulation.
- **What it tells us**: This is a core Lua module and is always loaded.

---

### **55. `vim.lsp.log`**
- **What it is**: A Neovim module for LSP logging.
- **What it tells us**: This is part of Neovim’s LSP support.

---

### **56. `lazyvim.util`**
- **What it is**: A utility module from `LazyVim` for general-purpose
  functionality.
- **What it tells us**: This is part of the `LazyVim` framework.

---

### **57. `lazy.core.handler.cmd`**
- **What it is**: A core module from `lazy.nvim` for handling plugin commands.
- **What it tells us**: This is part of the `lazy.nvim` plugin manager.

---

### **58. `vim.lsp.codelens`**
- **What it is**: A Neovim module for LSP code lens functionality.
- **What it tells us**: This is part of Neovim’s LSP support.

---

### **59. `lazy.async`**
- **What it is**: A module from `lazy.nvim` for asynchronous operations.
- **What it tells us**: This is part of the `lazy.nvim` plugin manager.

---

### **60. `vim.lsp.rpc`**
- **What it is**: A Neovim module for LSP remote procedure calls.
- **What it tells us**: This is part of Neovim’s LSP support.

---

### **61. `vim.lsp.sync`**
- **What it is**: A Neovim module for LSP synchronization.
- **What it tells us**: This is part of Neovim’s LSP support.

---

### **62. `vim.lsp.util`**
- **What it is**: A Neovim module for LSP utility functions.
- **What it tells us**: This is part of Neovim’s LSP support.

---

### **63. `vim.F`**
- **What it is**: A Neovim module for functional programming utilities.
- **What it tells us**: This is part of Neovim’s core functionality.

---

### **64. `vim.highlight`**
- **What it is**: A Neovim module for syntax highlighting.
- **What it tells us**: This is part of Neovim’s core functionality.

---

### **65. `mpack`**
- **What it is**: A Lua module for MessagePack serialization.
- **What it tells us**: This is used for data serialization in plugins
  or Neovim itself.

---

### **66. `vim.lsp._changetracking`**
- **What it is**: An internal Neovim module for tracking changes in
  LSP buffers.
- **What it tells us**: This is part of Neovim’s LSP support.

---

### **67. `lazy.manage.process`**
- **What it is**: A module from `lazy.nvim` for managing plugin processes.
- **What it tells us**: This is part of the `lazy.nvim` plugin manager.

---

### **68. `debug`**
- **What it is**: The Lua standard library module for debugging.
- **What it tells us**: This is a core Lua module and is always loaded.

---

### **69. `vim.treesitter.language`**
- **What it is**: A Neovim module for Tree-sitter language support.
- **What it tells us**: This is part of Neovim’s Tree-sitter integration.

---

### **70. `lazy.core.handler.keys`**
- **What it is**: A core module from `lazy.nvim` for handling key mappings.
- **What it tells us**: This is part of the `lazy.nvim` plugin manager.

---

### **71. `lazyvim.config`**
- **What it is**: A module from `LazyVim` for configuration management.
- **What it tells us**: This is part of the `LazyVim` framework.

---

### **72. `vim.version`**
- **What it is**: A Neovim module for version information.
- **What it tells us**: This is part of Neovim’s core functionality.

---

### **73. `luv`**
- **What it is**: The Lua binding for the `libuv` library, used for
  asynchronous I/O.
- **What it tells us**: This is part of Neovim’s asynchronous I/O system.

---

### **74. `lazyvim.util.deprecated`**
- **What it is**: A utility module from `LazyVim` for handling deprecated
  functionality.
- **What it tells us**: This is part of the `LazyVim` framework.
...
### **75. `lazy`**
- **What it is**: The main module for the `lazy.nvim` plugin manager.
- **What it tells us**: The `lazy.nvim` plugin manager is loaded and active.

---

### **76. `catppuccin.palettes`**
- **What it is**: A module from the `catppuccin` colorscheme for managing
  color palettes.
- **What it tells us**: This is part of the `catppuccin` colorscheme.

---

### **77. `lazy.core.cache`**
- **What it is**: A core module from `lazy.nvim` for caching plugin data.
- **What it tells us**: This is part of the `lazy.nvim` plugin manager.

---

### **78. `os`**
- **What it is**: The Lua standard library module for operating system
  interactions.
- **What it tells us**: This is a core Lua module and is always loaded.
...
### **79. `lpeg`**
- **What it is**: A Lua module for Parsing Expression Grammars (PEGs).
- **What it tells us**: This is used for advanced text parsing in plugins or
  Neovim itself.

---

### **80. `bit`**
- **What it is**: A Lua module for bitwise operations.
- **What it tells us**: This is used for low-level operations in plugins or
  Neovim itself.

---

### **81. `vim.lsp.buf`**
- **What it is**: A Neovim module for LSP buffer-related functionality.
- **What it tells us**: This is part of Neovim’s LSP support.

---

### **82. `io`**
- **What it is**: The Lua standard library module for input/output operations.
- **What it tells us**: This is a core Lua module and is always loaded.

---

### **83. `coroutine`**
- **What it is**: The Lua standard library module for coroutines.
- **What it tells us**: This is a core Lua module and is always loaded.

---

### **84. `jit.opt`**
- **What it is**: A LuaJIT module for Just-In-Time compilation optimizations.
- **What it tells us**: This is part of LuaJIT’s performance optimization system.

---

### **85. `lazyvim.util.pick`**
- **What it is**: A utility module from `LazyVim` for picking items (e.g., from
  a list).
- **What it tells us**: This is part of the `LazyVim` framework.

---

### **86. `catppuccin.groups.integrations.bufferline`**
- **What it is**: A module from the `catppuccin` colorscheme for integrating with
  the `bufferline` plugin.
- **What it tells us**: The `catppuccin` colorscheme is integrated with `bufferline`.

---

### **87. `vim.lsp.protocol`**
- **What it is**: A Neovim module for LSP protocol definitions.
- **What it tells us**: This is part of Neovim’s LSP support.
...
1. The Neovim setup is using the `lazy.nvim` plugin manager and the `LazyVim`
   framework.
3. Plugins like `catppuccin`, `nvim-treesitter` and `vim.lsp` are loaded and
   active.
5. Core Lua and Neovim modules are functioning as expected.
6. The configuration includes custom modules like `snacks` and `config.lazy`.

## One-liner No. 2

Let’s break down the **one-liner** and its **output** in detail, explain what it 
tells us and explore how we may tweak it for different purposes.
...
#### **What It Does**
1. **`nvim --headless`**:
   - Starts Neovim in headless mode (no UI), which is ideal for scripting and
     automation.

2. **`-c 'lua ...'`**:
   - Executes a Lua command inside Neovim.

3. **`for k, v in pairs(package.loaded)`**:
   - Iterates through the `package.loaded` table, which is a Lua global that tracks
     all loaded modules.

4. **`if string.match(k, "^[^/]+$")`**:
   - Filters out modules that contain a `/` in their name (e.g., core Lua modules
     or nested plugin files).
   - Ensures only top-level plugin names are included.

5. **`print(k .. ": " .. tostring(v))`**:
   - Prints the plugin name (`k`) and its loading status (`v`).
   - `tostring(v)` converts the status to a string (`true` if loaded, `nil` if not).

6. **`-c 'q'`**:
   - Quits Neovim after executing the command.

---

### **What the Output Tells Us**
The output lists all **loaded plugins** and their **status** (e.g., `table: 0x...` 
or `true`). Here’s how to interpret it:

1. **`table: 0x...`**:
   - Indicates that the plugin is loaded and its module is a Lua table.
   - The `0x...` is the memory address of the table.

2. **`true`**:
   - Indicates that the plugin is loaded, but its module is not a table (e.g., it
     could be a boolean, function, or other type).

3. **Plugin Names**:
   - Each line represents a plugin or module (e.g., `lazy.core.handler.keys`,
     `vim.lsp`, `catppuccin`).
...
1. **Plugin Manager**:
   - `lazy`, `lazy.core`, and `lazyvim` are loaded, indicating you’re using the
     `lazy.nvim` plugin manager with the `LazyVim` framework.

2. **Core Plugins**:
   - `vim.lsp`, `vim.treesitter`, and `catppuccin` are loaded, showing that LSP,
     Tree-sitter, and the Catppuccin colorscheme are active.

3. **Custom Configurations**:
   - `config.lazy`, `config.keymaps`, and `config.options` are loaded, indicating
     custom configurations for `lazy.nvim`, keymaps, and options.

4. **Core Lua Modules**:
   - `package`, `math`, `string`, and `table` are core Lua modules and are always
     loaded.

---

### **How to Tweak the One-Liner for Different Purposes**

#### **1. Filter Specific Plugins**
If you only want to check the status of specific plugins (e.g., `catppuccin` and 
`lazy`), modify the `string.match` condition:

```bash
nvim --headless -c 'lua for k, v in pairs(package.loaded) do if string.match(k, "^(catppuccin|lazy)$") then print(k .. ": " .. tostring(v)) end end' -c 'q'
```

- **What it does**:
  - Only prints plugins matching `catppuccin` or `lazy`.

---

#### **2. Show Only Loaded Plugins**
If you only want to see plugins that are successfully loaded (`true` or `table`), 
add a condition to filter out `nil` values:

```bash
nvim --headless -c 'lua for k, v in pairs(package.loaded) do if string.match(k, "^[^/]+$") and v then print(k .. ": " .. tostring(v)) end end' -c 'q'
```

- **What it does**:
  - Skips plugins that are not loaded (`nil`).

---

#### **3. Export Output to a File**
If you want to save the output to a file for further analysis, redirect the 
output:

```bash
nvim --headless -c 'lua for k, v in pairs(package.loaded) do if string.match(k, "^[^/]+$") then print(k .. ": " .. tostring(v)) end end' -c 'q' > plugins.txt
```

- **What it does**:
  - Saves the output to `plugins.txt`.

---

#### **4. Inspect Plugin Metadata**
If you want to inspect the metadata or configuration of a specific plugin (e.g., 
`catppuccin`), use `vim.inspect`:

```bash
nvim --headless -c 'lua print(vim.inspect(require("catppuccin")))' -c 'q'
```

- **What it does**:
  - Prints the plugin’s configuration table in a readable format.

---

#### **5. Check Plugin Dependencies**
If you want to list the dependencies of a specific plugin (e.g., `lazy.nvim`), 
use:

```bash
nvim --headless -c 'lua print(vim.inspect(require("lazy").spec.plugins))' -c 'q'
```

- **What it does**:
  - Prints the plugin specification table, including dependencies.

---

#### **6. Debug Plugin Errors**
If you want to catch and debug errors thrown by a plugin (e.g., `catppuccin`), 
use `xpcall`:

```bash
nvim --headless -c 'lua xpcall(function() require("catppuccin") end, function(err) print(debug.traceback(err)) end)' -c 'q'
```

- **What it does**:
  - Catches and prints any errors thrown by the plugin.

---

#### **7. Profile Plugin Loading Time**
If you want to profile the loading time of plugins, use `--startuptime`:

```bash
nvim --headless --startuptime /tmp/startup.log +q && cat /tmp/startup.log | grep lazy
```

- **What it does**:
  - Logs the startup time of plugins and filters the output to show only entries
    related to `lazy.nvim`.

---

### **Summary**
This one-liner is a powerful tool for debugging and inspecting plugins in Neovim. 
By tweaking its **filters**, **conditions**, and **output format**, you can adapt 
it for various purposes, such as:
- Listing loaded plugins.
- Inspecting plugin configurations.
- Debugging plugin errors.
- Profiling plugin performance.

To list **all plugins** (not core modules) irrespective of their status, and optionally sort them alphabetically or by letter, we can modify the one-liner to focus on plugins specifically. Here's how you can achieve this:

---

### **1. List All Plugins (Irrespective of Status)**
This one-liner lists all plugins, including those that are not loaded, by inspecting the `package.loaded` table and filtering out core modules:

```bash
nvim --headless -c 'lua for k, _ in pairs(package.loaded) do if string.match(k, "^[^/]+$") and not string.match(k, "^[vim|jit|bit|ffi|coroutine|debug|io|math|os|package|string|table]$") then print(k) end end' -c 'q'
```

- **What it does**:
  - Iterates through `package.loaded` to list all top-level modules.
  - Filters out core Lua and Neovim modules (e.g., `vim`, `jit`, `math`, etc.).
  - Prints only plugin names.

---

### **2. Sort Plugins Alphabetically**
To sort the plugins alphabetically, pipe the output to `sort`:

```bash
nvim --headless -c 'lua for k, _ in pairs(package.loaded) do if string.match(k, "^[^/]+$") and not string.match(k, "^[vim|jit|bit|ffi|coroutine|debug|io|math|os|package|string|table]$") then print(k) end end' -c 'q' | sort
```

- **What it does**:
  - Lists all plugins and sorts them alphabetically.

---

### **3. Filter Plugins by Starting Letter**
To list plugins that start with a specific letter (e.g., `l`), use `grep`:

```bash
nvim --headless -c 'lua for k, _ in pairs(package.loaded) do if string.match(k, "^[^/]+$") and not string.match(k, "^[vim|jit|bit|ffi|coroutine|debug|io|math|os|package|string|table]$") then print(k) end end' -c 'q' | grep '^l'
```

- **What it does**:
  - Lists all plugins starting with the letter `l`.
  - Replace `'^l'` with any other letter (e.g., `'^c'` for plugins starting with `c`).

---

### **4. List Plugins with Their Status**
If you want to list all plugins with their status (loaded or not), and sort them alphabetically:

```bash
nvim --headless -c 'lua for k, v in pairs(package.loaded) do if string.match(k, "^[^/]+$") and not string.match(k, "^[vim|jit|bit|ffi|coroutine|debug|io|math|os|package|string|table]$") then print(k .. ": " .. tostring(v)) end end' -c 'q' | sort
```

- **What it does**:
  - Lists all plugins with their status (`true` if loaded, `nil` if not).
  - Sorts the output alphabetically.

---

### **5. List Plugins from `lazy.nvim` Spec**
If you’re using `lazy.nvim`, you can directly inspect its plugin specifications to list all configured plugins (even if they’re not loaded):

```bash
nvim --headless -c 'lua for k, _ in pairs(require("lazy").spec.plugins) do print(k) end' -c 'q' | sort
```

- **What it does**:
  - Lists all plugins configured in `lazy.nvim`, irrespective of their loading status.
  - Sorts the output alphabetically.

---

### **6. Export Plugins to a File**
To save the list of plugins to a file, redirect the output:

```bash
nvim --headless -c 'lua for k, _ in pairs(package.loaded) do if string.match(k, "^[^/]+$") and not string.match(k, "^[vim|jit|bit|ffi|coroutine|debug|io|math|os|package|string|table]$") then print(k) end end' -c 'q' | sort > plugins.txt
```

- **What it does**:
  - Saves the sorted list of plugins to `plugins.txt`.

---

### **7. Count the Number of Plugins**
To count the total number of plugins:

```bash
nvim --headless -c 'lua local count = 0; for k, _ in pairs(package.loaded) do if string.match(k, "^[^/]+$") and not string.match(k, "^[vim|jit|bit|ffi|coroutine|debug|io|math|os|package|string|table]$") then count = count + 1 end end; print("Total plugins: " .. count)' -c 'q'
```

- **What it does**:
  - Counts and prints the total number of plugins.

---

### **8. List Plugins with Descriptions**
If your plugins have metadata (e.g., descriptions), you can extract and display it:

```bash
nvim --headless -c 'lua for k, _ in pairs(package.loaded) do if string.match(k, "^[^/]+$") and not string.match(k, "^[vim|jit|bit|ffi|coroutine|debug|io|math|os|package|string|table]$") then local ok, plugin = pcall(require, k); if ok and plugin._meta and plugin._meta.description then print(k .. ": " .. plugin._meta.description) else print(k) end end end' -c 'q' | sort
```

- **What it does**:
  - Lists plugins with their descriptions (if available).
  - Falls back to the plugin name if no description is found.

---

### **Summary**
These one-liners allow you to:
1. List all plugins (excluding core modules).
2. Sort plugins alphabetically or filter them by starting letter.
3. Export the list to a file.
4. Count the total number of plugins.
5. Extract plugin metadata (e.g., descriptions).

# The Following Distro Dotfyle Markdown Summary are Plugins I Wish to Install and Integrate with this config.

# b9_OVIWrite/

<a href="https://dotfyle.com/b9Joker108/boviwrite"><img src="https://dotfyle.com/b9Joker108/boviwrite/badges/plugins?style=flat" /></a>
<a href="https://dotfyle.com/b9Joker108/boviwrite"><img src="https://dotfyle.com/b9Joker108/boviwrite/badges/leaderkey?style=flat" /></a>
<a href="https://dotfyle.com/b9Joker108/boviwrite"><img src="https://dotfyle.com/b9Joker108/boviwrite/badges/plugin-manager?style=flat" /></a>
...
```sh
git clone git@github.com:b9Joker108/b9_OVIWrite ~/.config/b9Joker108/b9_OVIWrite
```

Open Neovim with this config:

```sh
NVIM_APPNAME=b9Joker108/b9_OVIWrite/ nvim
```
...
+ [iamcco/markdown-preview.nvim](https://dotfyle.com/plugins/iamcco/markdown-preview.nvim)
+ [jghauser/auto-pandoc.nvim](https://dotfyle.com/plugins/jghauser/auto-pandoc.nvim)
### media
